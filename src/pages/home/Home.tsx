...
const Home = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 text-white overflow-hidden relative">
      ...
      <section
        id="nosotros"
        className="py-32 bg-white text-gray-900 relative overflow-hidden"
      >
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-12 py-6 text-xl rounded-full shadow-lg shadow-cyan-500/25 border-0"
              >
